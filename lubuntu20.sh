...
apt install -y docker-ce-cli=5:20.10.21~3-0~ubuntu-focal
apt install -y docker-ce-rootless-extras=5:20.10.21~3-0~ubuntu-focal
apt install -y docker-scan-plugin=0.23.0~ubuntu-focal
apt install -y docker-compose-plugin=2.11.2~ubuntu-focal
apt install -y docker-ce=5:20.10.21~3-0~ubuntu-focal
