...
apt update
apt install -y containerd.io=1.6.31-1
apt install -y docker-ce-cli=5:20.10.21~3-0~ubuntu-jammy
apt install -y docker-ce-rootless-extras=5:20.10.21~3-0~ubuntu-jammy
apt install -y docker-scan-plugin=0.23.0~ubuntu-jammy
apt install -y docker-compose-plugin=2.11.2~ubuntu-jammy
apt install -y docker-ce=5:20.10.21~3-0~ubuntu-jammy
